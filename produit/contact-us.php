    ...
    <div class="page"><a class="section section-banner d-none d-xl-block" alt="" width="1600" height="310"></a>
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-39">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Nous contacter</h2>
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#">La Ferme du Bois, 01370 Treffort-Cuisiat</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
      ...
      <section class="section section-md section-last bg-default text-md-left">
        <div class="container">
          <div class="row row-50">
            ...
            <div class="col-lg-6">
              <h4 class="text-spacing-50">Contact</h4>
              <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                <div class="row row-14 gutters-14">
                  ...
                  <div class="col-sm-6">
                    <div class="form-wrap">
                      ...
                      <label class="form-label" for="contact-last-name">Prénom</label>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-wrap">
                ...
                <button class="button button-primary button-pipaluk" type="submit">Envoyer Message</button>
              </form>
            </div>
          </div>
        </div>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-3">
                <div class="oh-desktop">
                  <div class="wow slideInRight" data-wow-delay="0s">
                    ...
                    <p>Bionet est une ferme biologique située en France. Nous offrons des aliments et des produits sains à nos clients.</p>
